...
load("./inputs/BGCv11_16VAR_SubZone_RFmodel.Rdata")
Edatope <- fread("./InputsGit/Edatopic_v11_7.csv",data.table = F)
rawDat <- fread("./inputs/SunshPts_90 GCMsMSY.csv",data.table = F)
rawDat$ID2 <- gsub("(.*)[A-Z]$","\\1",rawDat$ID2) ##remove north/south
SSPredFull <- CCISS_Spp(Y1 = rawDat,BGCmodel = BGCmodel,E1 = Edatope)
...
myColours <- c("darkmagenta","darkorchid4","green4","gold","plum2","plum1","slategray4","dodgerblue2","darkorange2",
          "mediumaquamarine","seagreen1","palevioletred1","palevioletred2")
names(myColours) <- Trees
